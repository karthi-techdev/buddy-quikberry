...
import { faHouse, faPenToSquare, faImage, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
...
const SideBar = () => {
  ...
  return (
    <div className="bg-[#0d1525] text-white w-[12.5rem] md:w-64 h-screen p-4 space-y-4">
