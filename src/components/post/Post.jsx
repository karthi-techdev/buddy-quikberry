...
const Post = () => {
  ...
  return (
    <div className="text-white p-4 bg-[#0F172A]">
      <h2 className="text-white mb-3 text-[2rem] font-bold text-center">Post's</h2>
...
const PostCard = ({ post }) => {
  ...
  return (
    <div
      ref={ref}
      className={`bg-[#1c2b45] p-6 rounded-2xl shadow-md border border-[#2d3a5a] hover:shadow-lg transition duration-300 transform ${
